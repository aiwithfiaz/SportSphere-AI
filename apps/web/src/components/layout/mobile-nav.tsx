...
const mainNavItems: NavItem[] = [
  ...
  { title: "Cricket", href: "/matches/cricket", icon: Trophy },
  { title: "Football", href: "/matches/football", icon: Trophy },
  { title: "Basketball", href: "/matches/basketball", icon: Trophy },
  { title: "Baseball", href: "/matches/baseball", icon: Trophy },
  { title: "Hockey", href: "/matches/hockey", icon: Trophy },
  { title: "Tennis", href: "/matches/tennis", icon: Trophy },
